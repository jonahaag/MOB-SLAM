...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        print("When starting the simulation the camera follows the keypoint-navigation specified in 'SofaViewer/Trajectories/navigation/keypoints1b.txt'. After that you can move around using the w-a-s-d and arrowkeys!")
