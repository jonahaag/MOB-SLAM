...
class EngineORB:
    ...
    def __init__(self, mat_dir,
                 ...
                 mode="fromfile", trajectory_path="sofaviewer/trajectories/navigation/"):   
    ...
    def main_slam(self, image):
        ...
        if self.mat.workspace['isKeyFrame']: # save camera position corresponding to keyframes
            ...
            #self.pts = nxs.initialize_network_3D(self.mat.workspace['worldpoints'])
            plotter.plot_slam_results(worldpoint_plot=self.main_window.worldpoint_plot, 
    ...
    def stop_slam(self):
        ...
        plotter.plot_ground_truth(ground_truth_plot=self.main_window.ground_truth_plot,
